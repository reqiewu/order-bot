...
export function IconList({ size, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
      ...
      <path d="M4.2 7h.01M4.2 12h.01M4.2 17h.01" {...stroke} />
    </Svg>
  );
}

export function IconStatus({ size, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
      <path d="M4 14.5 8.2 9l3.3 4.2L16 7.5 20 12" {...stroke} />
...
export function IconSliders({ size = 36, className }: IconProps) {
  return (
    <Svg size={size} className={className}>
      <path d="M4 8h16M4 16h16" {...stroke} />
      <circle cx="9" cy="8" r="2.1" {...stroke} />
      <circle cx="15" cy="16" r="2.1" {...stroke} />
    </Svg>
  );
}
